...
int main(int argc, char **argv)
{
	...
	data.addr = ai->ai_canonname;
	data.received = 0;
	if (ttl)
		data.rtt = (double *)calloc(ttl, sizeof(double));
	else
		data.rtt = (double *)calloc(999, sizeof(double));
